...
CREATE TABLE `solicitudes` (
  ...
  `ruta_adjunto_solicitud` VARCHAR(255) NULL COMMENT 'Ruta al archivo adjunto de la solicitud (ej. carta de vacación)',
...
CREATE TABLE `personal_fichas` (
  ...
  `dias_vacacion_anuales_asignados` INT DEFAULT 20 COMMENT 'Días de vacación asignados anualmente por política',
...
('Funcionario Estándar', 'Acceso base para todos los empleados, principalmente consultas y descarga de formularios.', '{"VER_PERFIL": true, "EDITAR_PERFIL": true, "VER_CORRESPONDENCIA_PROPIA": false, "REDACTAR_CORRESPONDENCIA_INTERNA": false, "VER_DETALLE_DOCUMENTO": true, "SOLICITAR_VACACION": false, "SOLICITAR_MATERIAL": false, "SOLICITAR_ACTIVO": false, "VER_HISTORIAL_SOLICITUDES_PROPIAS": true, "VER_DASHBOARD": true, "VER_COMUNICADOS": true, "DESCARGAR_FORMULARIOS": true, "VER_MIS_VACACIONES": true, "VER_MIS_MATERIALES_ENTREGADOS": true, "VER_INFO_PERSONAL_RRHH": true}'),
('Secretaria de Dirección', 'Gestiona correspondencia externa y flujo inicial de vacaciones.', '{"VER_PERFIL": true, "EDITAR_PERFIL": true, "VER_CORRESPONDENCIA_PROPIA": true, "REDACTAR_CORRESPONDENCIA_INTERNA": true, "VER_DETALLE_DOCUMENTO": true, "SOLICITAR_VACACION": false, "SOLICITAR_MATERIAL": false, "SOLICITAR_ACTIVO": false, "VER_HISTORIAL_SOLICITUDES_PROPIAS": true, "VER_DASHBOARD": true, "REGISTRAR_CORRESPONDENCIA_EXTERNA": true, "CONTROLAR_SOLICITUDES_VACACION_SECRETARIA": false, "REGISTRAR_VACACION_APROBADA": true, "VER_COMUNICADOS": true, "DESCARGAR_FORMULARIOS": true, "VER_MIS_VACACIONES": true, "VER_MIS_MATERIALES_ENTREGADOS": true, "VER_INFO_PERSONAL_RRHH": true}'),
('Director Administrativo', 'Aprueba solicitudes de materiales/activos, gestiona pagos y asistencia.', '{"VER_PERFIL": true, "EDITAR_PERFIL": true, "VER_CORRESPONDENCIA_PROPIA": true, "REDACTAR_CORRESPONDENCIA_INTERNA": true, "VER_DETALLE_DOCUMENTO": true, "SOLICITAR_VACACION": false, "SOLICITAR_MATERIAL": false, "SOLICITAR_ACTIVO": false, "VER_HISTORIAL_SOLICITUDES_PROPIAS": true, "VER_DASHBOARD": true, "APROBAR_SOLICITUDES_ADMIN": true, "GESTIONAR_PAGOS": true, "IMPORTAR_BIOMETRICO": true, "VER_REPORTES_ASISTENCIA": true, "GESTIONAR_STOCK_MATERIALES": true, "VER_STOCK_MATERIALES": true, "CREAR_COMUNICADOS": true, "VER_COMUNICADOS": true, "VER_REPORTE_VACACIONES_PERSONAL": true, "REGISTRAR_SOLICITUD_ESCANEO": true, "DESCARGAR_FORMULARIOS": true, "VER_MIS_VACACIONES": true, "VER_MIS_MATERIALES_ENTREGADOS": true, "VER_INFO_PERSONAL_RRHH": true}'),
('Director General Ejecutivo (MAE)', 'Máxima autoridad, aprueba vacaciones y puede delegar funciones.', '{"VER_PERFIL": true, "EDITAR_PERFIL": true, "VER_CORRESPONDENCIA_PROPIA": false, "REDACTAR_CORRESPONDENCIA_INTERNA": false, "VER_DETALLE_DOCUMENTO": true, "SOLICITAR_VACACION": false, "SOLICITAR_MATERIAL": false, "SOLICITAR_ACTIVO": false, "VER_HISTORIAL_SOLICITUDES_PROPIAS": true, "VER_DASHBOARD": true, "APROBAR_VACACIONES_MAE": true, "DELEGAR_AUTORIDAD_SISTEMA": true, "CREAR_COMUNICADOS": true, "VER_COMUNICADOS": true, "VER_REPORTE_VACACIONES_PERSONAL": true, "DESCARGAR_FORMULARIOS": true, "VER_MIS_VACACIONES": true, "VER_MIS_MATERIALES_ENTREGADOS": true, "VER_INFO_PERSONAL_RRHH": true}'),
('Técnico de Sistemas', 'Administra usuarios, roles y configuración del sistema.', '{"VER_PERFIL": true, "EDITAR_PERFIL": true, "VER_CORRESPONDENCIA_PROPIA": true, "REDACTAR_CORRESPONDENCIA_INTERNA": true, "VER_DETALLE_DOCUMENTO": true, "SOLICITAR_VACACION": true, "SOLICITAR_MATERIAL": true, "SOLICITAR_ACTIVO": true, "VER_HISTORIAL_SOLICITUDES_PROPIAS": true, "VER_DASHBOARD": true, "CRUD_USUARIOS_SISTEMA": true, "CRUD_ROLES_SISTEMA": true, "CONFIGURAR_SISTEMA": true, "VER_COMUNICADOS": true, "DESCARGAR_FORMULARIOS": true, "VER_MIS_VACACIONES": true, "VER_MIS_MATERIALES_ENTREGADOS": true, "VER_INFO_PERSONAL_RRHH": true}'),
('Encargada de Presupuesto', 'Gestiona la ficha del personal.', '{"VER_PERFIL": true, "EDITAR_PERFIL": true, "VER_CORRESPONDENCIA_PROPIA": true, "REDACTAR_CORRESPONDENCIA_INTERNA": true, "VER_DETALLE_DOCUMENTO": true, "SOLICITAR_VACACION": false, "SOLICITAR_MATERIAL": false, "SOLICITAR_ACTIVO": false, "VER_HISTORIAL_SOLICITUDES_PROPIAS": true, "VER_DASHBOARD": true, "CRUD_PERSONAL_FICHA": true, "VER_DETALLE_PERSONAL_FICHA": true, "VER_COMUNICADOS": true, "DESCARGAR_FORMULARIOS": true, "VER_MIS_VACACIONES": true, "VER_MIS_MATERIALES_ENTREGADOS": true, "VER_INFO_PERSONAL_RRHH": true}'),
('Mensajero', 'Visualiza hoja de ruta y registra entregas.', '{"VER_PERFIL": true, "EDITAR_PERFIL": true, "VER_CORRESPONDENCIA_PROPIA": false, "REDACTAR_CORRESPONDENCIA_INTERNA": false, "VER_DETALLE_DOCUMENTO": true, "SOLICITAR_VACACION": false, "SOLICITAR_MATERIAL": false, "SOLICITAR_ACTIVO": false, "VER_HISTORIAL_SOLICITUDES_PROPIAS": true, "VER_DASHBOARD": true, "VER_HOJA_RUTA_MENSAJERO": true, "VER_COMUNICADOS": true, "DESCARGAR_FORMULARIOS": true, "VER_MIS_VACACIONES": true, "VER_MIS_MATERIALES_ENTREGADOS": true, "VER_INFO_PERSONAL_RRHH": true}'),
('Encargado de Activos Fijos', 'Gestiona el inventario y asignación de activos.', '{"VER_PERFIL": true, "EDITAR_PERFIL": true, "VER_CORRESPONDENCIA_PROPIA": true, "REDACTAR_CORRESPONDENCIA_INTERNA": true, "VER_DETALLE_DOCUMENTO": true, "SOLICITAR_VACACION": false, "SOLICITAR_MATERIAL": false, "SOLICITAR_ACTIVO": false, "VER_HISTORIAL_SOLICITUDES_PROPIAS": true, "VER_DASHBOARD": true, "VER_INVENTARIO_ACTIVOS": true, "ASIGNAR_NUEVO_ACTIVO": true, "GESTIONAR_STOCK_MATERIALES": true, "VER_COMUNICADOS": true, "REGISTRAR_SOLICITUD_ESCANEO": true, "DESCARGAR_FORMULARIOS": true, "VER_MIS_VACACIONES": true, "VER_MIS_MATERIALES_ENTREGADOS": true, "VER_INFO_PERSONAL_RRHH": true}'),
('Encargada de Archivo', 'Gestiona préstamos y recepción de expedientes físicos.', '{"VER_PERFIL": true, "EDITAR_PERFIL": true, "VER_CORRESPONDENCIA_PROPIA": true, "REDACTAR_CORRESPONDENCIA_INTERNA": true, "VER_DETALLE_DOCUMENTO": true, "SOLICITAR_VACACION": false, "SOLICITAR_MATERIAL": false, "SOLICITAR_ACTIVO": false, "VER_HISTORIAL_SOLICITUDES_PROPIAS": true, "VER_DASHBOARD": true, "GESTIONAR_PRESTAMOS_ARCHIVO": true, "RECEPCIONAR_EXPEDIENTES_ARCHIVO": true, "VER_COMUNICADOS": true, "DESCARGAR_FORMULARIOS": true, "VER_MIS_VACACIONES": true, "VER_MIS_MATERIALES_ENTREGADOS": true, "VER_INFO_PERSONAL_RRHH": true}');
